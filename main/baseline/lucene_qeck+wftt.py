...
def rank_code_score(pred_path,file_path,lang_type,pair_m,word_n):
    ...
    # 保存数据
    result_data.to_csv(pred_path + '%s_parse_pred_res4.csv' % lang_type, sep='|', encoding='utf-8')  # 保存行名
    print('预测数据处理完毕！')
